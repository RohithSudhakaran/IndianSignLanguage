...
hands = mp_hands.Hands(
    min_detection_confidence=0.7,  # Original values
...
gesture_label = input("🤚 Enter the gesture label (e.g., A-Z, 0-9, space): ").strip()
...
if os.path.exists(csv_file):
    choice = input(f"⚠️ Data for '{gesture_label}' already exists. Do you want to replace it? (y/n): ").strip().lower()
    if choice == 'y':
        # Overwrite file
